...
public class Config {
    ...
    private static final String accessKeyId = "LTAI4FeokCX2r94YsgoTPUMd"; //TODO: 这里要写成你自己生成的
    private static final String accessKeySecret = "VwdPyIE5lZMMMh4oNzdHktUK677x9l";//TODO: 这里要写成你自己生成的
